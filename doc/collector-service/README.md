...
In the *Connext* 7.3.1 release, *Collector Service* provides native integration
...
[RTI documentation](https://community.rti.com/static/documentation/connext-dds/7.3.1/doc/manuals/connext_dds_professional/observability/index.html#).
...
[Connext Monitoring Library 2.0](https://community.rti.com/static/documentation/connext-dds/7.3.1/doc/manuals/connext_dds_professional/observability/library.html)
...
```
-v /path/to/your_license.dat:/opt/rti.com/rti_connext_dds-7.3.1/rti_license.dat
```
...
* ```/home/rtiuser/rti_workspace/7.3.1/user_config/collector_service```
...
```
docker cp collector_service:/opt/rti.com/rti_connext_dds-7.3.1/resource/xml/RTI_COLLECTOR_SERVICE.xml .
```
...
[Generating the Observability Framework Security Artifacts](https://community.rti.com/static/documentation/connext-dds/7.3.1/doc/manuals/connext_dds_professional/observability/security.html#generating-the-observability-framework-security-artifacts).
...
```/home/rtiuser/rti_workspace/7.3.1/user_config/collector_service/USER_COLLECTOR_SERVICE.xml```
...
docker run -dt \
        --network host \
        -v $PWD/rti_license.dat:/opt/rti.com/rti_connext_dds-7.3.1/rti_license.dat \
        -v $PWD/MyCollectorService.xml:/home/rtiuser/rti_workspace/7.3.1/user_config/collector_service/USER_COLLECTOR_SERVICE.xml \
...
```
docker cp collector_service:/opt/rti.com/rti_connext_dds-7.3.1/RTI_License_Agreement.pdf .
```
