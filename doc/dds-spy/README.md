...
For additional information on *RTI DDS Spy*, refer to the [RTI documentation](https://community.rti.com/static/documentation/connext-dds/7.3.1/doc/manuals/connext_dds_professional/tools/rti_dds_spy/introduction.html).
...
* ```/home/rtiuser/rti_workspace/7.3.1/user_config/spy```
...
```
docker cp dds_spy:/opt/rti.com/rti_connext_dds-7.3.1/resource/xml/RTI_DDS_SPY_QOS_PROFILES.xml .
```
...
``/home/rtiuser/rti_workspace/7.3.1/user_config/spy/USER_DDS_SPY_QOS_PROFILES.xml``
...
docker run -dt \
        --network host \
        -v $PWD/MyQOSProfiles.xml:/home/rtiuser/rti_workspace/7.3.1/user_config/spy/USER_DDS_SPY_QOS_PROFILES.xml \
        --name=dds_spy \
        rticom/dds-spy:latest \
        -domainId 0 \
...
```
docker cp dds_spy:/opt/rti.com/rti_connext_dds-7.3.1/RTI_License_Agreement.pdf .
```
