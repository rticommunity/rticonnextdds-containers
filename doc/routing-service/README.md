...
For additional information on *RTI Routing Service*, refer to the [RTI documentation](https://community.rti.com/static/documentation/connext-dds/7.3.1/doc/manuals/connext_dds_professional/services/routing_service/index.html).
...
* ```/home/rtiuser/rti_workspace/7.3.1/user_config/routing_service```
...
```
docker cp routing_service:/opt/rti.com/rti_connext_dds-7.3.1/resource/xml/RTI_ROUTING_SERVICE.xml .
```
...
```/home/rtiuser/rti_workspace/7.3.1/user_config/routing_service/USER_ROUTING_SERVICE.xml```
...
docker run -dt \
        --network host \
        -v $PWD/rti_license.dat:/opt/rti.com/rti_connext_dds-7.3.1/rti_license.dat \
        -v $PWD/MyRoutingService.xml:/home/rtiuser/rti_workspace/7.3.1/user_config/routing_service/USER_ROUTING_SERVICE.xml \
        --name=routing_service \
        rticom/routing-service:latest \
...
```
docker cp routing_service:/opt/rti.com/rti_connext_dds-7.3.1/RTI_License_Agreement.pdf .
```
