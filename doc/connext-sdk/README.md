...
The generated image is based on `rticom/connext-base`, which uses
[Ubuntu](https://hub.docker.com/_/ubuntu). It may install operating-system
packages, language runtimes and other third-party components, including
