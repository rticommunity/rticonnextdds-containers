...
For additional information on *RTI Web Integration Service*, refer to the [RTI documentation](https://community.rti.com/static/documentation/connext-dds/7.6.0/doc/manuals/connext_dds_professional/services/web_integration_service/index.html).
...
docker run -dt \
        ...
        -documentRoot /home/rtiuser/rti_workspace/7.6.0/examples/web_integration_service
```
...
* ```/home/rtiuser/rti_workspace/7.6.0/user_config/web_integration_service```
...
```
docker cp web_integration_service:/opt/rti.com/rti_connext_dds-7.6.0/resource/xml/RTI_WEB_INTEGRATION_SERVICE.xml
```
...
```/home/rtiuser/rti_workspace/7.6.0/user_config/web_integration_service/USER_WEB_INTEGRATION_SERVICE.xml```
...
docker run -dt \
        --network host \
        -v $PWD/rti_license.dat:/opt/rti.com/rti_connext_dds-7.6.0/rti_license.dat \
        -v $PWD/MyWebIntegrationService.xml:/home/rtiuser/rti_workspace/7.6.0/user_config/web_integration_service/USER_WEB_INTEGRATION_SERVICE.xml \
        --name=web_integration_service \
        rticom/web-integration-service:latest \
...
```
docker cp web_integration_service:/opt/rti.com/rti_connext_dds-7.6.0/RTI_License_Agreement.pdf .
```
