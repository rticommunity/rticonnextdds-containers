...
For additional information on *RTI DDS Ping*, refer to the [RTI documentation](https://community.rti.com/static/documentation/connext-dds/7.3.1/doc/manuals/connext_dds_professional/tools/rti_dds_ping/introduction.html).
...
```sh
RTI Connext DDS Ping built with DDS version: 7.3.1
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
* ```/home/rtiuser/rti_workspace/7.3.1/user_config/ping```

## Built-in configuration
Use the following command to retrieve the *DDS Ping* built-in configuration file:

```
docker cp dds_ping_publisher:/opt/rti.com/rti_connext_dds-7.3.1/resource/xml/RTI_DDS_PING_QOS_PROFILES.xml .
```
...
```/home/rtiuser/rti_workspace/7.3.1/user_config/ping/USER_DDS_PING_QOS_PROFILES.xml```
...
docker run -dt \
        --network host \
        -v $PWD/MyQOSProfiles.xml:/home/rtiuser/rti_workspace/7.3.1/user_config/ping/USER_DDS_PING_QOS_PROFILES.xml \
        --name=dds_ping_publisher \
        rticom/dds-ping:latest \
...
```
docker cp dds_ping:/opt/rti.com/rti_connext_dds-7.3.1/RTI_License_Agreement.pdf .
```
